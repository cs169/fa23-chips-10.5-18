...
Rails.application.routes.draw do
    ...
    resources :representatives do
        ...
        match '/representatives/:representative_id/my_news_item/new', to:  'my_news_items#create',
                                                                      via: [:post]
        match '/my_news_item/:issue/new', to:  'my_news_items#new_cont', via: [:post]
        # match '/representatives/:representative_id/my_news_item/:issue/new', to:  'my_news_items#new_cont',
        #                                                               via: [:post]
        # get '/my_news_item/:issue/new', to: 'my_news_items#new_cont'  
